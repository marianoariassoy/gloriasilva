  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          property='og:url'
          content='http://gloriasilvaphoto.com/imagenes'
        />
        <link
          rel='canonical'
          href='http://gloriasilvaphoto.com/imagenes'
        />
      </Helmet>
                ...
                >
                  <button
                    className={`hover:opacity-70 ${
                      item.id === itemShow && 'text-secondary'
                    }`}
      ...
      {itemShow &&
        data
          ...
          .map((item) => (
            <section
              key={item.id}
              className='mt-48 lg:mt-40 px-14 hidden lg:block'
            >
