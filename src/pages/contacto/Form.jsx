...
const Form = () => {
  ...
  const onSubmit = (data) => {
    setSending(true)
    const sender = {
      to: 'gloriasilvavillaocampo@gmail.com',
    ...
    axios
      .post('http://gloriasilvaphoto.com/backend/send-email.php', {
        ...data,
        ...sender,
      })
      .then((data) => {
          ...
          <div className='grid gap-3'>
            <div>
              ...
              <input
                ...
                className='w-full h-11 p-3 border'
              />
              {errors.name && <Error />}
            </div>
            <div>
            ...
            <div>
              {sending ? (
                ...
                <button className='bg-primary text-white px-10 py-3 text-sm inline-block hover:shadow-lg'>
                  {text[lan].send}
                </button>
              )}
            </div>
